...
CONFIG='my_configs/ade/mask2former_r50_8xb2-160k_ade20k-512x512_original.py'
GPUS=4
NNODES=${NNODES:-1}
...
GPUS_ids="6,7,8,9"
CHECKPOINT='local_results/ss/ADE20k/mask2former_r50_8xb2-160k_ade20k-512x512_original/best_mIoU_iter_135000.pth'
BASE_WORK_DIR='local_results/ss/ADE20k/mask2former_r50_8xb2-160k_ade20k-512x512_original'
