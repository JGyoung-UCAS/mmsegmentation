...
CONFIG='my_configs/ade/mask2former_r50_8xb2-160k_ade20k-512x512_suppressor_e1.py'
GPUS=4
NNODES=${NNODES:-1}
...
GPUS_ids="6,7,8,9"
CHECKPOINT='local_results/ss/ADE20k/mask2former_r50_8xb2-160k_ade20k-512x512_suppressor_e1/best_mIoU_iter_160000.pth'
BASE_WORK_DIR='local_results/ss/ADE20k/mask2former_r50_8xb2-160k_ade20k-512x512_suppressor_e1'
