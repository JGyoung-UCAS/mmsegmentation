...
CONFIG='my_configs/ade/ann_r50-d8_4xb4-80k_ade20k-512x512_original.py'
GPUS=4
NNODES=${NNODES:-1}
...
GPUS_ids="1,2,3,4"
CHECKPOINT='local_results/ss/ADE20k/ann_r50-d8_4xb4-80k_ade20k-512x512_original/iter_80000.pth'
BASE_WORK_DIR='local_results/ss/ADE20k/ann_r50-d8_4xb4-80k_ade20k-512x512_original'
