...
CONFIG='my_configs/cityscapes/deeplabv3plus_r50-d8_4xb2-40k_cityscapes-512x1024_original_official.py'
GPUS=4
NNODES=${NNODES:-1}
...
GPUS_ids="6,7,8,9"
CHECKPOINT='local_results/ss/cityscapes/deeplabv3plus_r50-d8_4xb2-40k_cityscapes-512x1024_original_official/deeplabv3plus_r50-d8_512x1024_40k_cityscapes_20200605_094610-d222ffcd.pth'
BASE_WORK_DIR='local_results/ss/cityscapes/deeplabv3plus_r50-d8_4xb2-40k_cityscapes-512x1024_original_official'
