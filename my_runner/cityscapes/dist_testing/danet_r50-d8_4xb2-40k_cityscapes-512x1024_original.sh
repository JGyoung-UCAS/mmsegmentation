...
GPUS_ids="1,2,3,4"
CHECKPOINT='local_results/ss/cityscapes/danet_r50-d8_4xb2-40k_cityscapes-512x1024_original/iter_40000.pth'
BASE_WORK_DIR='local_results/ss/cityscapes/danet_r50-d8_4xb2-40k_cityscapes-512x1024_original'
