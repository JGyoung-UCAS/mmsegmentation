...
CONFIG='my_configs/cityscapes/deeplabv3plus_r50-d8_4xb2-40k_cityscapes-512x1024_suppressor_e1.py'
GPUS=4
NNODES=${NNODES:-1}
...
GPUS_ids="1,2,3,4"
CHECKPOINT='local_results/ss/cityscapes/deeplabv3plus_r50-d8_4xb2-40k_cityscapes-512x1024_suppressor_e1/iter_40000.pth'
BASE_WORK_DIR='local_results/ss/cityscapes/deeplabv3plus_r50-d8_4xb2-40k_cityscapes-512x1024_suppressor_e1'
