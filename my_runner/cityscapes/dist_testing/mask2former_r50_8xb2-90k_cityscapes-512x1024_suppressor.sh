...
GPUS_ids="6,7,8,9"
CHECKPOINT='local_results/ss/cityscapes/mask2former_r50_8xb2-90k_cityscapes-512x1024_suppressor/best_mIoU_iter_65000.pth'
BASE_WORK_DIR='local_results/ss/cityscapes/mask2former_r50_8xb2-90k_cityscapes-512x1024_suppressor'
