...
CONFIG='my_configs/voc12_aug/ccnet_r50-d8_4xb4-20k_voc12aug-512x512_suppressor.py'
GPUS=4
NNODES=${NNODES:-1}
...
GPUS_ids="6,7,8,9"
CHECKPOINT='local_results/ss/voc12_aug/ccnet_r50-d8_4xb4-20k_voc12aug-512x512_suppressor/iter_20000.pth'
BASE_WORK_DIR='local_results/ss/voc12_aug/ccnet_r50-d8_4xb4-20k_voc12aug-512x512_suppressor'
