...
CONFIG='my_configs/voc12_aug/deeplabv3plus_r50-d8_4xb4-20k_voc12aug-512x512_original.py'
GPUS=4
NNODES=${NNODES:-1}
...
GPUS_ids="1,2,3,4"
CHECKPOINT='local_results/ss/voc12_aug/deeplabv3plus_r50-d8_4xb4-20k_voc12aug-512x512_original/iter_20000.pth'
BASE_WORK_DIR='local_results/ss/voc12_aug/deeplabv3plus_r50-d8_4xb4-20k_voc12aug-512x512_original'
