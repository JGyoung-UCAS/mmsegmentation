...
data_root = 'local_results/ss/voc12_aug/ann_r50-d8_4xb4-20k_voc12aug-512x512_suppressor_e5_allstem_frozen'
...
total_index = ['voc12aug']
total_columns = ['aAcc','mIoU','mAcc']
total_df = pd.DataFrame(data=0, columns=total_columns, index=total_index)
total_df.loc['voc12aug','aAcc'] = round(imc_df_aacc.loc['clean','1'],2)
total_df.loc['voc12aug','mIoU'] = round(imc_df_miou.loc['clean','1'],2)
total_df.loc['voc12aug','mAcc'] = round(imc_df_macc.loc['clean','1'],2)

total_df.loc['voc12aug-C','aAcc'] = round(average_excluding_first_row_aacc,2)
total_df.loc['voc12aug-C','mIoU'] = round(average_excluding_first_row_miou,2)
total_df.loc['voc12aug-C','mAcc'] = round(average_excluding_first_row_macc,2)
